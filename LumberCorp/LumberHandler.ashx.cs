...
{
    /// <summary>
    /// Summary description for LumberHandler
    /// </summary>
    public class LumberHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                System.IO.FileStream fileStream = new FileStream(context.Server.MapPath(@"/data/BGA.xls"), FileMode.OpenOrCreate);
