<%@ Control  Debug="true" Language="C#" AutoEventWireup="true" CodeBehind="AdminControl.ascx.cs" Inherits="LumberCorp.AdminControl1" %>
...
<% 
    ...
    if (user != null)
    {
        if (user.Status == 2)
        {
            ...
            List<Node> nodes = ContentManagementSystem.GetNodesIgnoringContentAndImages();
            if( nodes != null )
                if (nodes.Count > 0)
                {
                    Response.Write("<div class=\"module\">");
